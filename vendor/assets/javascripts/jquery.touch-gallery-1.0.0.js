...
(function($) {
	...
	function zoomOut(large, small, onFinish) {
		...
		var w = b.width;//Math.min(b.height * t.width / t.height, b.width);
		var h = b.height;//Math.min(b.width * t.height / t.width, b.height);
